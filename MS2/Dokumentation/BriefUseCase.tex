\begin{table}[]
\centering
\caption{Brief-Use-Cases - Aquariumverwaltung}
\label{tab:bucaquarium}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|p{4cm}|p{4cm}|p{6cm}|p{3cm}|p{4cm}|l}
\hline
\textbf{actor} & \textbf{goal} & \textbf{brief} & \textbf{Trigger} & \textbf{Problem} \\ \hline
...
\begin{table}[]
\centering
\caption{Brief-Use-Cases - Kundenverwaltung}
\label{tab:buckunde}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|p{4cm}|p{4cm}|p{6cm}|p{3cm}|p{4cm}|l}
\hline

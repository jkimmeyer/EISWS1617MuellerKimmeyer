...
public class AppFrame extends JFrame {
    ...
    public void initComponents(){
        ...
        int tabbedPaneMargin = 10;
        int tabbedPaneWidth = java.awt.Toolkit.getDefaultToolkit().getScreenSize().width-(2*tabbedPaneMargin);
        int tabbedPaneHeight = java.awt.Toolkit.getDefaultToolkit().getScreenSize().height-(2*tabbedPaneMargin)-60;
        ...
        this.khWertLabel.setText("KarbonathÃ¤rte:");
    ...
    private void openCustomerTab(Customer customer){
    	JComponent panel = makeCustomerPanel(customer);
		tabbedPane.addTab(customer.getName(), null, panel, customer.getName());
    }
    
    protected JComponent makeCustomerPanel(Customer customer) {
    ...
    protected JComponent makeSearchPanel() {
        ...
        JButton openCustomerBtn = new JButton("Öffnen");
        openCustomerBtn.addActionListener(new ActionListener(){

			@Override
			public void actionPerformed(ActionEvent arg0) {
				tabbedPane.remove(searchPanel);
				openCustomerTab(new Customer(1, "Moritz"));
				tabbedPane.addTab("+", null, searchPanel, "Kunde öffnen");
				tabbedPane.setSelectedComponent(latestCustomer);
			}
        });
        panel.add(openCustomerBtn);
        JButton openCustomerBtn2 = new JButton("Öffnen");
        openCustomerBtn2.addActionListener(new ActionListener(){

			@Override
			public void actionPerformed(ActionEvent arg0) {
				tabbedPane.remove(searchPanel);
				openCustomerTab(new Customer(1, "Tim"));
				tabbedPane.addTab("+", null, searchPanel, "Kunde öffnen");
				tabbedPane.setSelectedComponent(latestCustomer);
			}
        });
        panel.add(openCustomerBtn2);
        ...
        this.absendenBtn.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
              ...
              //Umwandlung der Werte in Strings  
                ...
                //doppelter Typecast, weil die Funktion Floats empfÃ¤ngt - kann man in nÃ¤chster Version besser machen, fÃ¼rs RP reicht es 
                ...
                //Senden der Daten an den Server und den dazugehÃ¶rigen Client
